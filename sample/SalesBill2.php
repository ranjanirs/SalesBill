...
?>
	...
	<div  class="ContentWrapper1" align="center">
		...
		<form id="frmsales" name="frmsales" method="post"  action="SalesBillSave1.php" enctype="multipart/form-data">
				...
				<div class="divOuter1">
					...
					<div class="divlabelOuter"> 
							...
							<div class="divtxtEmpName1" >
								<input type="text" size="12" id="txtDate1" name="txtDate1"  autocomplete="off"  />
						...
						<div class="divlblEmpname1">Party</div>
							<div class="divtxtEmpName1" >
								<?php
									$servername = "localhost";
									$username = "root";
									...
									if ($result->num_rows > 0) {
									echo "<select name='SelPartyName' id='SelPartyName'>";
							...
							<div class="divlblEmpname1">Quantity</div>
							
								<div class="divtxtEmpName1">
									<input type="text" id="txtQuantity" name="txtQuantity"  onkeyup="ValProductValue()" />
								
							</div>
						
						
						
						<div class="divlblEmpname1">rate</div>
						<div class="divtxtEmpName1" >
							<input type="text" id="txtrate" name="txtrate" onkeyup="ValProductValue()"  />
						...
						<!-- table content -->
				<div id="divtabledis" style="margin-top:50px">
